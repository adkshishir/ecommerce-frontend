...
const ProductCard = ({image,name,price,stock,className,alt}:ProductCardProps) => {
  return (
             <div className={`w-full col-lg-3 col-md-6 col-sm-12 ${className}`}>
                <div className="product-item bg-light mb-4">
                  <div className="product-img position-relative overflow-hidden">
                    <Image height={100} width={100} className="img-fluid w-100" src={image||"/img/product-1.jpg"} alt={alt} />
