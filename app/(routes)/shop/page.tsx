  ...
  <div className="row px-xl-5">
    ...
    <div className="col-lg-9 col-md-8">
      <div className="row pb-3">
        ...
        <ProductCard image='/img/product-1.jpg' name='Product Name Goes Here' price={100} stock={100} className='col-lg-4 col-md-6 col-sm-6 pb-1' />
        <ProductCard image='/img/product-2.jpg' name='Product Name Goes Here' price={100} stock={100} className='col-lg-4 col-md-6 col-sm-6 pb-1' />
        <ProductCard image='/img/product-3.jpg' name='Product Name Goes Here' price={100} stock={100} className='col-lg-4 col-md-6 col-sm-6 pb-1' />
        <ProductCard image='/img/product-4.jpg' name='Product Name Goes Here' price={100} stock={100} className='col-lg-4 col-md-6 col-sm-6 pb-1' />
        <ProductCard image='/img/product-5.jpg' name='Product Name Goes Here' price={100} stock={100} className='col-lg-4 col-md-6 col-sm-6 pb-1' />
        <ProductCard image='/img/product-6.jpg' name='Product Name Goes Here' price={100} stock={100} className='col-lg-4 col-md-6 col-sm-6 pb-1' />
        <ProductCard image='/img/product-7.jpg' name='Product Name Goes Here' price={100} stock={100} className='col-lg-4 col-md-6 col-sm-6 pb-1' />
        <ProductCard image='/img/product-8.jpg' name='Product Name Goes Here' price={100} stock={100} className='col-lg-4 col-md-6 col-sm-6 pb-1' />
        <ProductCard image='/img/product-9.jpg' name='Product Name Goes Here' price={100} stock={100} className='col-lg-4 col-md-6 col-sm-6 pb-1' />
